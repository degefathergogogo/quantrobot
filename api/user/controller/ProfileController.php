...
class ProfileController extends RestUserBaseController
{
    ...
    public function userInfo($field = '')
    {
        ...
        if ($this->request->isGet()) {
            ...
            $fieldStr = 'id,mobile,user_email,user_nickname,avatar,score,user_status,create_time,invitation_code,has_paypwd,auth_id,is_google_check';
            if (empty($field)) {
            ...
            $userData['invitation_url'] = Apibase::sp_get_host(). '/#/register?code='.$userData['invitation_code'];
